#
#  Be sure to run `pod spec lint EasyTableView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "liuxuleidota"
  # s.authors            = { "liuxuleidota" => "liu_xu_lei@163.com" }
  # s.social_media_url   = "http://twitter.com/liuxuleidota"
  ...
  s.source       = { :git => "https://github.com/liuxuleidota/EasyTableView.git", :tag => "0.0.1" }
